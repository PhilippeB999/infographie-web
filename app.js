...
const STORAGE_KEY = "infoquest_state_v1";
...
const ACCESS_CODE = "INFOGRAPHIE-2026-HYJL"; // code fourni au centre de formation après achat de la licence
...
const SYNC_KEY = "infoquest_sync_pending";
